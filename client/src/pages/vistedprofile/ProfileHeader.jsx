...
function VisitedProfileHeader() {
  ...
  return (
    <div className="bg-white  dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-800">
      {showChatBox && (
        <div className="fixed top-64 right-0 z-50 sm:mr-8 mb-4 w-full  sm:w-80 bg-white dark:bg-gray-800 rounded-t-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 transform rounded-lg">
      ...
      {showFollowersModal && (
        <div className="absolute top-56 lg:top-48 sm:left-44 lg:left-96 w-60 dark:text-gray-300 z-20 ">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md max-h-[80vh] overflow-hidden border border-gray-200 dark:border-gray-700">
            ...
            <div className="overflow-y-auto max-h-[60vh] hidel_slide_roler">
              {followers.slice(0, 50).map((follower) => (
                <div
                  key={follower.id}
                  className="flex items-center p-3 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700"
                >
                  <img
                    src={follower.avatar}
                    alt={follower.name}
      ...
      {/* Following Modal */}
      {showFollowingModal && (
        <div className="absolute top-56 lg:top-48 sm:left-64 lg:left-[500px] w-60 dark:text-gray-300 z-20  ">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md max-h-[80vh] overflow-hidden border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
              <h3 className="text-lg font-semibold">
