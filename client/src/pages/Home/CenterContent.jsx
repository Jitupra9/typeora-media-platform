...
function CenterContent({
  ...
  return (
    <div
      ...
      className="lg:col-span-6 pb-3 lg:pb-5 space-y-6 hidel_slide_roler lg:h-[calc(100vh-80px)] overflow-y-auto"
    >
      {activeView === "home" ? (
        <>
            ...
            <div className="flex justify-between mt-4 pt-3 border-t dark:border-gray-700 border-gray-200">
              <button className="flex items-center space-x-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 px-3 py-1.5 rounded-lg flex-1 justify-center">
                ...
                <span className=" flex gap-2">
                  Live <span className=" hidden sm:flex">Video</span>
                </span>
              </button>
              <button className="flex items-center space-x-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 px-3 py-1.5 rounded-lg flex-1 justify-center">
          ...
          <div className="dark:bg-gray-900 bg-white rounded-2xl shadow-lg p-4">
            <h2 className="font-bold text-lg mb-4 px-2 hidden sm:block">
              Your Stories
            </h2>
            <div className="flex gap-3 p-3 overflow-x-auto pb-2 hidel_slide_roler">
              {stories.map((story) => (
                <div
                  key={story.id}
                ...
                >
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gray-400 dark:bg-gray-700 flex flex-col items-center justify-end pb-4`}
                    >
                      <div className="relative -mt-8 mb-2">
                        ...
                        >
                          <div className="h-full w-full rounded-full bg-gray-200 dark:bg-gray-900 flex items-center justify-center font-bold text-sm">
                            {story.avatar}
                          </div>
                        </div>
                        {story.isNew && (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t dark:from-black/60 to-transparent"></div>
                    </div>
