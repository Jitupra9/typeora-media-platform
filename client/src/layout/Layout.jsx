...
function Layout() {
  ...
  return (
    <Headercontext>
      <div className="flex w-[100vw] h-[100vh] fixed top-0 bg-gray-300 bg-opacity-50 dark:bg-gray-950 ">
        ...
        <div className=" w-full lg:w-[84%]  flex flex-col">
          ...
          <div className="p-3 sm:p-5  h-full overflow-y-scroll hidel_slide_roler">
            <Outlet />
          </div>
        </div>
      </div>
